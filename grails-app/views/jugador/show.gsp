...
<html>
    ...
    <body>
        ...
        <div id="show-jugador" class="content scaffold-show" role="main">
            ...
            <f:display bean="jugador" />
            <g:form resource="${this.jugador}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.jugador}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
