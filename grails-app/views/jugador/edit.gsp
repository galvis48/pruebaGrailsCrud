...
<html>
    ...
    <body>
        ...
        <div id="edit-jugador" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.jugador}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.jugador}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.jugador}" method="PUT">
                <g:hiddenField name="version" value="${this.jugador?.version}" />
                <fieldset class="form">
                    <f:all bean="jugador"/>
                </fieldset>
